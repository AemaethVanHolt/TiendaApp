    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Administrador del sistema", new DateTime(2025, 7, 30, 0, 20, 40, 181, DateTimeKind.Utc).AddTicks(3071), "Administrador" },
                    { 2, true, "Cliente de la tienda", new DateTime(2025, 7, 30, 0, 20, 40, 181, DateTimeKind.Utc).AddTicks(3360), "Cliente" }
                });
